...
<body>
    ...
    <div style='margin-top: 30px;' class="d-flex justify-content-center col-sm-12">
        ...
        require('process-addTeachAssigned.php');
        } 
        ?>
        <div class="col-sm-8">
        <h2 class="h2 text-center">Add Teach Assigned</h2>
            <form action="addTeachAssigned.php" method="post"
            name="addTeachAssignedform" id="addTeachAssignedform">
                <div class="form-group row">
                    <label for="subjectid" class="col-sm-4 col-form-label">Subject Id:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="subjectid" name="subjectid" 
                    placeholder="Subject Id" required
                    value="<?php if (isset($_POST['subjectid'])) echo $_POST['subjectid']; ?>" >
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    value="<?php if (isset($_POST['teacherid'])) echo $_POST['teacherid']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="classid" class="col-sm-4 col-form-label">Class Id</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="classid" name="classid" 
                    placeholder="Class Id" required
                    value="<?php if (isset($_POST['classid'])) echo $_POST['classid']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12">
