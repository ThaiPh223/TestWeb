...
<body>
    ...
    <div style='margin-top: 30px;' class="d-flex justify-content-center col-sm-12">
        ...
        require('process-addMajor.php');
        } 
        ?>
        <div class="col-sm-8">
        <h2 class="h2 text-center">Add Major</h2>
            <form action="addMajor.php" method="post"
            name="addMajorform" id="addMajorform">
                <div class="form-group row">
                    <label for="majorName" class="col-sm-4 col-form-label">Major Name:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="majorName" name="majorName" 
                    placeholder="Major Name" maxlength="30" required
                    value="<?php if (isset($_POST['majorName'])) echo $_POST['majorName']; ?>" >
                    </div>
                </div>
                <div class="form-group row">
                    <label for="majorDes" class="col-sm-4 col-form-label">Major Description:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="majorDes" name="majorDes" 
                    placeholder="Major Description" required
                    value="<?php if (isset($_POST['majorDes'])) echo $_POST['majorDes']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12">
