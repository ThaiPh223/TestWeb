...
<body>
    ...
    <div style='margin-top: 30px;' class="d-flex justify-content-center col-sm-12">
        ...
        require('process-addTeacher.php');
        } 
        ?>
        <div class="col-sm-8">
        <h2 class="h2 text-center">Add Teacher</h2>
            <form action="addTeacher.php" method="post"
            name="addTeacherform" id="addTeacherform">
                <div class="form-group row">
                    <label for="teacherLastName" class="col-sm-4 col-form-label">Teacher Last Name:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="teacherLastName" name="teacherLastName" 
                    placeholder="Teacher Last Name" required
                    value="<?php if (isset($_POST['teacherLastName'])) echo $_POST['teacherLastName']; ?>" >
                    </div>
                </div>
                <div class="form-group row">
                    <label for="teacherFirstName" class="col-sm-4 col-form-label">Teacher First Name:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="teacherFirstName" name="teacherFirstName" 
                    placeholder="Teacher First Name" required
                    value="<?php if (isset($_POST['teacherFirstName'])) echo $_POST['teacherFirstName']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="teacherBirth" class="col-sm-4 col-form-label">Teacher Birth:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="teacherBirth" name="teacherBirth" 
                    placeholder="Teacher Birth" required
                    value="<?php if (isset($_POST['teacherBirth'])) echo $_POST['teacherBirth']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="teacherPhone" class="col-sm-4 col-form-label">Teacher Phone:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="teacherPhone" name="teacherPhone" 
                    placeholder="Teacher Phone" required
                    value="<?php if (isset($_POST['teacherPhone'])) echo $_POST['teacherPhone']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="teacherMail" class="col-sm-4 col-form-label">Teacher Mail:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="teacherMail" name="teacherMail" 
                    placeholder="Teacher Mail" required
                    value="<?php if (isset($_POST['teacherMail'])) echo $_POST['teacherMail']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="teacherAddress" class="col-sm-4 col-form-label">Teacher Address:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="teacherAddress" name="teacherAddress" 
                    placeholder="Teacher Address" required
                    value="<?php if (isset($_POST['teacherAddress'])) echo $_POST['teacherAddress']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12">
