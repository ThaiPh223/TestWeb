    ...
    <div style="margin-bottom: 40px;" class="text-center main-content">
        ...
        <?php
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<td style="border: 2px solid">'.'<a href="edit-teachingPlan.php?id='.$row['teachingPlanId'].'">Edit</a>'.'</td>';
                echo '<td style="border: 2px solid">'.'<a href="delete-teachingPlan.php?id='.$row['teachingPlanId'].'">Delete</a>'.'</td>';
                }
            }
            echo '</table>';
            echo '</font>';
