...
<body>
    ...
    <div style='margin-top: 30px;' class="d-flex justify-content-center col-sm-12">
        ...
        require('process-addClass.php');
        } 
        ?>
        <div class="col-sm-8">
        <h2 class="h2 text-center">Add Class</h2>
            <form action="addClass.php" method="post"
            name="addClassform" id="addClassform">
                <div class="form-group row">
                    <label for="className" class="col-sm-4 col-form-label">Class Name:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="className" name="className" 
                    placeholder="Class Name" required
                    value="<?php if (isset($_POST['className'])) echo $_POST['className']; ?>" >
                    </div>
                </div>
                <div class="form-group row">
                    <label for="classYear" class="col-sm-4 col-form-label">Class Year:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="classYear" name="classYear" 
                    placeholder="Class Year" required
                    value="<?php if (isset($_POST['classYear'])) echo $_POST['classYear']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="classSemester" class="col-sm-4 col-form-label">Class Semester:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="classSemester" name="classSemester" 
                    placeholder="Class Semester" required
                    value="<?php if (isset($_POST['classSemester'])) echo $_POST['classSemester']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="classStage" class="col-sm-4 col-form-label">Class Stage:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="classStage" name="classStage" 
                    placeholder="Class Stage" required
                    value="<?php if (isset($_POST['classStage'])) echo $_POST['classStage']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="classDateStart" class="col-sm-4 col-form-label">Class Date Start:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="classDateStart" name="classDateStart" 
                    placeholder="Class Date Start" required
                    value="<?php if (isset($_POST['classDateStart'])) echo $_POST['classDateStart']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="classDateEnd" class="col-sm-4 col-form-label">CLass Date End:</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="classDateEnd" name="classDateEnd" 
                    placeholder="CLass Date End" required
                    value="<?php if (isset($_POST['classDateEnd'])) echo $_POST['classDateEnd']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12">
